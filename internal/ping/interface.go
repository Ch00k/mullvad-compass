...
type PingerFactory interface {
	...
	CreatePinger(ipVersion relays.IPVersion, socketType icmp.SocketType) (Pinger, error)
}
...
func (f *defaultPingerFactory) CreatePinger(ipVersion relays.IPVersion, socketType icmp.SocketType) (Pinger, error) {
	return newSocketManager(ipVersion, socketType)
}
